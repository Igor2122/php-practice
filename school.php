<?php 
    ...
    if(!$firstName || !$lastName){
        ...
        echo 'This is only for highschool students, please enter a grade between 9 and 12';
    } else {
        ...
        if($class_avarage < 70){
            ...
            switch ($grade) {
                case 9:
                    $messageBody = "Congratulations on completing your freshman year in High School with $grade grade! We’ll see you on September 1st for the start of your sophomore year!";
                    break;
                case 10: 
    ...
    // if($class_avarage < 70) {
    //     echo "Dear $name,We look forward to seeing you at summer school, beginning July 1st!";
    // } else if($class_avarage >= 70 && $grade == 9) {
    //     echo "Dear $name, Congratulations on completing your freshman year in High School! We’ll see you on September 1st for the start of your sophomore year!";
    // } else if ($class_avarage >= 70 && $grade == 10) {
    //     echo "Dear $name, Congratulations on completing your sophomore year in High School! We’ll see you on September 1st for the start of your junior year!";
    // }
